...
内容
  ...
  * [使用配置缓存](#%E4%BD%BF%E7%94%A8%E9%85%8D%E7%BD%AE%E7%BC%93%E5%AD%98)
  * [IDE支持](#IDE%E6%94%AF%E6%8C%81)
  * [支持的插件](#%E6%94%AF%E6%8C%81%E7%9A%84%E6%8F%92%E4%BB%B6)
  * [故障排除](#%E6%95%85%E9%9A%9C%E6%8E%92%E9%99%A4)
  * [领养步骤](#Adoption+steps+%EF%BC%88%E9%87%87%E7%BA%B3%E6%AD%A5%E9%AA%A4%29)
  * [测试您的构建逻辑](#%E6%B5%8B%E8%AF%95%E6%82%A8%E7%9A%84%E6%9E%84%E5%BB%BA%E9%80%BB%E8%BE%91)
  * [要求](#%E8%A6%81%E6%B1%82)
  * [尚未实现](#%E5%B0%9A%E6%9C%AA%E5%AE%9E%E7%8E%B0)
...
并非所有[核心Gradle插件](#%E6%94%AF%E6%8C%81%E7%9A%84%E6%8F%92%E4%BB%B6:core)都受支持。您的内部版本和所依赖的插件可能需要更改才能满足[要求](#%E8%A6%81%E6%B1%82)。一些Gradle功能[尚未实现](#%E5%B0%9A%E6%9C%AA%E5%AE%9E%E7%8E%B0)。尚未通过配置缓存改进在IDE中导入和同步Gradle构建。  
...
### [性能提升](#%E4%BB%8B%E7%BB%8D:performance_improvements)
...
### [进行配置缓存](#%E8%BF%9B%E8%A1%8C%E9%85%8D%E7%BD%AE%E7%BC%93%E5%AD%98)
...
如果在缓存或重用配置时发现任何问题，则会生成HTML报告来帮助您诊断和解决问题。有关更多信息，请参见下面的“[故障排除”](#%E6%95%85%E9%9A%9C%E6%8E%92%E9%99%A4)部分。

继续阅读以了解如何调整配置缓存，在出现问题时手动使状态无效，并使用IDE中的配置缓存。

### [启用配置缓存](#%E4%BD%BF%E7%94%A8%E9%85%8D%E7%BD%AE%E7%BC%93%E5%AD%98:enable)
...
### [忽略问题](#%E5%BF%BD%E7%95%A5%E9%97%AE%E9%A2%98)
...
### [允许最大数量的问题](#%E5%85%81%E8%AE%B8%E6%9C%80%E5%A4%A7%E6%95%B0%E9%87%8F%E7%9A%84%E9%97%AE%E9%A2%98)
...
### [使缓存无效](#%E4%BD%BF%E7%BC%93%E5%AD%98%E6%97%A0%E6%95%88)

当配置阶段的输入发生更改时，配置缓存将自动失效。但是，某些输入尚未被跟踪，因此当未跟踪到配置阶段的输入发生更改时，您可能必须手动使配置缓存无效。如果您[忽略问题，](#%E5%BF%BD%E7%95%A5%E9%97%AE%E9%A2%98)可能会发生这种情况。有关更多信息，请参见下面的“[需求](#%E8%A6%81%E6%B1%82)和[尚未实现”](#%E5%B0%9A%E6%9C%AA%E5%AE%9E%E7%8E%B0)部分。
...
### [基于IntelliJ的IDE](#IDE%E6%94%AF%E6%8C%81:intellij)
...
### [Eclipse IDE](#IDE%E6%94%AF%E6%8C%81:eclipse)
...
配置缓存是全新的，并引入了插件实现的新要求。结果，核心Gradle插件和社区插件都需要进行调整。本节提供有关[Gradle核心插件](#%E6%94%AF%E6%8C%81%E7%9A%84%E6%8F%92%E4%BB%B6:core)和[社区插件](#%E6%94%AF%E6%8C%81%E7%9A%84%E6%8F%92%E4%BB%B6:community)当前支持的信息。

### [Core Gradle插件](#%E6%94%AF%E6%8C%81%E7%9A%84%E6%8F%92%E4%BB%B6:core)
并非所有的[Gradle核心插件都](/md/插件参考.md#plugin_reference)支持配置缓存。

![plugiconfiguration_cache_n.png](img/plugiconfiguration_cache_n.png)
  
### [社区插件](#%E6%94%AF%E6%8C%81%E7%9A%84%E6%8F%92%E4%BB%B6:community)
...
① [在配置时读取未声明的系统属性](#%E6%9C%AA%E7%BB%8F%E5%A3%B0%E6%98%8E%E7%9A%84%E8%AF%BB%E5%8F%96%E7%B3%BB%E7%BB%9F%E5%B1%9E%E6%80%A7)  

② [`Project`在执行时使用对象](#%E4%BD%BF%E7%94%A8%60Project%60%E5%AF%B9%E8%B1%A1)  
...
运行该任务失败，并在控制台中打印以下内容：
      ...
      * What went wrong:
      ...
      - Build file 'build.gradle': read system property 'someDestination'
        See https://docs.gradle.org/0.0.0/userguide/configuration_cache.html#%E6%9C%AA%E7%BB%8F%E5%A3%B0%E6%98%8E%E7%9A%84%E8%AF%BB%E5%8F%96%E7%B3%BB%E7%BB%9F%E5%B1%9E%E6%80%A7
      - Build file 'build.gradle': invocation of 'Task.project' at execution time is unsupported.
        See https://docs.gradle.org/0.0.0/userguide/configuration_cache.html#%E4%BD%BF%E7%94%A8%60Project%60%E5%AF%B9%E8%B1%A1
...
报告中显示的问题具有指向相应[要求的](#%E8%A6%81%E6%B1%82)链接，您可以在其中找到有关解决问题的指南或[尚未实现](#%E5%B0%9A%E6%9C%AA%E5%AE%9E%E7%8E%B0)的相应功能。

在更改构建或插件以解决问题时，应考虑[使用TestKit测试构建逻辑](#%E6%B5%8B%E8%AF%95%E6%82%A8%E7%9A%84%E6%9E%84%E5%BB%BA%E9%80%BB%E8%BE%91)。  
  
╚═════════════════════════════  
  
在此阶段，您可以决定[将问题变成警告，](#%E5%BF%BD%E7%95%A5%E9%97%AE%E9%A2%98)然后继续探索构建对配置缓存的反应，或者解决当前的问题。
...
①  我们将临时任务变成了适当的任务类，  
②  带有输入和输出声明，  
③  并在`FileSystemOperations`服务中注入了的受支持替代[`project.copy{}`](#%E4%BD%BF%E7%94%A8%60Project%60%E5%AF%B9%E8%B1%A1)。  
④  最后，我们将[在配置时使用](#%E6%9C%AA%E7%BB%8F%E5%A3%B0%E6%98%8E%E7%9A%84%E8%AF%BB%E5%8F%96%E7%B3%BB%E7%BB%9F%E5%B1%9E%E6%80%A7)的[系统属性](#%E6%9C%AA%E7%BB%8F%E5%A3%B0%E6%98%8E%E7%9A%84%E8%AF%BB%E5%8F%96%E7%B3%BB%E7%BB%9F%E5%B1%9E%E6%80%A7)声明为构建配置输入，并将其连接到我们的任务输入。  
...
## [Adoption steps （采纳步骤)](#Adoption+steps+%EF%BC%88%E9%87%87%E7%BA%B3%E6%AD%A5%E9%AA%A4%29)

一个重要的前提条件是使Gradle和插件版本保持最新。以下内容探讨了成功采用的推荐步骤。它适用于构建和插件。在执行这些步骤时，请记住下面的[需求](#%E8%A6%81%E6%B1%82)一章中解释的HTML报告和解决方案。
...
不要在第一次构建失败时停止，而是[将问题变成警告，](#%E5%BF%BD%E7%95%A5%E9%97%AE%E9%A2%98)以发现您的构建和插件的行为。如果构建失败，请使用HTML报告来推断与失败有关的报告问题。继续运行更多有用的任务。

这将使您对构建和插件面临的问题的性质有一个很好的了解。请记住，将问题转变为警告时，如果出现问题，可能需要[手动使缓存无效](#%E4%BD%BF%E7%BC%93%E5%AD%98%E6%97%A0%E6%95%88)。
...
如果您遇到[Gradle功能](#%E5%B0%9A%E6%9C%AA%E5%AE%9E%E7%8E%B0)或本文档未涵盖的[Gradle核心插件](#%E6%94%AF%E6%8C%81%E7%9A%84%E6%8F%92%E4%BB%B6:core)的问题，请在上报告问题[`gradle/gradle`](https://github.com/gradle/gradle/issues/new/choose)。
...
考虑为构建逻辑添加测试。请参阅以下有关[测试](#%E6%B5%8B%E8%AF%95%E6%82%A8%E7%9A%84%E6%9E%84%E5%BB%BA%E9%80%BB%E8%BE%91)配置缓存的[构建逻辑的](#%E6%B5%8B%E8%AF%95%E6%82%A8%E7%9A%84%E6%9E%84%E5%BB%BA%E9%80%BB%E8%BE%91)部分。这将在迭代所需的更改时为您提供帮助，并防止将来发生退化。
...
cache`参数传递给[GradleRunner](https://docs.gradle.org/6.7.1/javadoc/org/gradle/testkit/runner/GradleRunner.html)或使用[启用配置缓存中](#%E4%BD%BF%E7%94%A8%E9%85%8D%E7%BD%AE%E7%BC%93%E5%AD%98:enable)描述的其他方法之一。
...
### [某些类型不能被任务引用](#%E8%A6%81%E6%B1%82:disallowed_types)
...
### [使用`Project`对象](#%E4%BD%BF%E7%94%A8%60Project%60%E5%AF%B9%E8%B1%A1)

任务`Project`在执行时不得使用任何对象。这包括`Task.getProject()`在任务运行时调用。

某些情况下可以采用与[不允许类型](#%E8%A6%81%E6%B1%82:disallowed_types)相同的方式进行修复。

通常情况下，类似的事情上都可用`Project`和`Task`。例如，如果您需要`Logger`在任务中执行操作，则应使用`Task.logger`而不是`Project.logger`。

否则，您可以使用[注入服务](/md/%E5%BC%80%E5%8F%91%E8%87%AA%E5%AE%9A%E4%B9%89Gradle%E7%B1%BB%E5%9E%8B.md%23%E6%9C%8D%E5%8A%A1%E6%B3%A8%E5%85%A5)代替的方法`Project`。
...
`project.properties`，`project.property(name)`，`project.hasProperty(name)`，`project.getProperty(name)`或者`project.findProperty(name)`|[Gradle属性的价值提供者](#%E6%9C%AA%E5%A3%B0%E6%98%8E%E9%98%85%E8%AF%BBGradle%E5%B1%9E%E6%80%A7)  
...
### [从另一个实例访问任务实例](#%E4%BB%8E%E5%8F%A6%E4%B8%80%E4%B8%AA%E5%AE%9E%E4%BE%8B%E8%AE%BF%E9%97%AE%E4%BB%BB%E5%8A%A1%E5%AE%9E%E4%BE%8B)

任务不应直接访问另一个任务实例的状态。相反，应该使用[输入和输出关系](/md/%E5%BB%B6%E8%BF%9F%E9%85%8D%E7%BD%AE.md%23%E4%BD%BF%E7%94%A8%E4%BB%BB%E5%8A%A1%E8%BE%93%E5%85%A5%E5%92%8C%E8%BE%93%E5%87%BA)来连接任务。

请注意，此要求使其不支持编写在执行时配置其他任务的任务。

### [使用构建监听器](#%E8%A6%81%E6%B1%82:build_listeners)
...
### [未声明阅读Gradle属性](#%E6%9C%AA%E5%A3%B0%E6%98%8E%E9%98%85%E8%AF%BBGradle%E5%B1%9E%E6%80%A7)
...
### [未经声明的读取系统属性](#%E6%9C%AA%E7%BB%8F%E5%A3%B0%E6%98%8E%E7%9A%84%E8%AF%BB%E5%8F%96%E7%B3%BB%E7%BB%9F%E5%B1%9E%E6%80%A7)
...
### [未经声明的读取环境变量](#%E8%A6%81%E6%B1%82:undeclared_env_var_read)
...
### [未声明读取文件](#%E8%A6%81%E6%B1%82:undeclared_file_read)
...
### [构建扫描支持](#%E5%B0%9A%E6%9C%AA%E5%AE%9E%E7%8E%B0:build_scan)

启用配置缓存的构建扫描功能需要Gradle Enterprise插件版本3.4或更高版本。使用早期版本时，使用配置缓存时将自动禁用内部版本扫描发布。

### [共享配置缓存](#%E5%B0%9A%E6%9C%AA%E5%AE%9E%E7%8E%B0:sharing)
...
### [自定义输入标准化](#%E8%87%AA%E5%AE%9A%E4%B9%89%E8%BE%93%E5%85%A5%E6%A0%87%E5%87%86%E5%8C%96)

使用配置缓存时，不会捕获自定义[输入归一化](/md/%E5%A4%84%E7%90%86%E4%BB%BB%E5%8A%A1.md%23%E9%85%8D%E7%BD%AE%E8%BE%93%E5%85%A5%E6%A0%87%E5%87%86%E5%8C%96)。如果您的构建具有用于输入归一化的配置，即`normalization
{ }`，它将被忽略，则不会报告任何问题。重复使用配置缓存的构建可能会看到构建缓存未命中，但将保持可靠。

参见[gradle / gradle＃13706](https://github.com/gradle/gradle/issues/13706)。

### [复合体](#%E5%B0%9A%E6%9C%AA%E5%AE%9E%E7%8E%B0:composite_builds)

在[复合构建](/md/复合构建.md#composite_builds)上使用配置缓存时，将报告问题。如果您[忽略问题，](#%E5%BF%BD%E7%95%A5%E9%97%AE%E9%A2%98)则在重新使用配置缓存时，将跳过包含的内部版本。

参见[gradle / gradle＃13503](https://github.com/gradle/gradle/issues/13503)。

### [源依赖](#%E6%BA%90%E4%BE%9D%E8%B5%96)
...
### [将Java代理与使用TestKit运行的构建一起使用](#%E5%B0%86Java%E4%BB%A3%E7%90%86%E4%B8%8E%E4%BD%BF%E7%94%A8TestKit%E8%BF%90%E8%A1%8C%E7%9A%84%E6%9E%84%E5%BB%BA%E4%B8%80%E8%B5%B7%E4%BD%BF%E7%94%A8)

使用[TestKit](/md/使用TestKit测试构建逻辑.md#test_kit)运行内部版本时，配置缓存可能会干扰应用于这些内部版本的Java代理（例如Jacoco代理）。

### [Java对象序列化](#%E5%B0%9A%E6%9C%AA%E5%AE%9E%E7%8E%B0:java_serialization)
