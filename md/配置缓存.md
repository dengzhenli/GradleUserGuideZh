...
### [它是如何工作的？](#%E4%BB%8B%E7%BB%8D:how_does_it_work)
...
### [启用配置缓存](#%E5%90%AF%E7%94%A8%E9%85%8D%E7%BD%AE%E7%BC%93%E5%AD%98)
...
② [`Project`在执行时使用对象](#%E8%A6%81%E6%B1%82:use_project_during_execution)  
...
运行该任务失败，并在控制台中打印以下内容：
      ...
      * What went wrong:
      ...
      - Build file 'build.gradle': invocation of 'Task.project' at execution time is unsupported.
        See https://docs.gradle.org/0.0.0/userguide/configuration_cache.html#%E8%A6%81%E6%B1%82:use_project_during_execution
...
①  我们将临时任务变成了适当的任务类，  
②  带有输入和输出声明，  
③  并在`FileSystemOperations`服务中注入了的受支持替代[`project.copy{}`](#%E8%A6%81%E6%B1%82:use_project_during_execution)。  
...
cache`参数传递给[GradleRunner](https://docs.gradle.org/6.7.1/javadoc/org/gradle/testkit/runner/GradleRunner.html)或使用[启用配置缓存中](#%E5%90%AF%E7%94%A8%E9%85%8D%E7%BD%AE%E7%BC%93%E5%AD%98)描述的其他方法之一。
...
### [使用`Project`对象](#%E8%A6%81%E6%B1%82:use_project_during_execution)
...
`project.properties`，`project.property(name)`，`project.hasProperty(name)`，`project.getProperty(name)`或者`project.findProperty(name)`|[Gradle属性的价值提供者](#%E8%A6%81%E6%B1%82:undeclared_gradle_prop_read)  
...
### [从另一个实例访问任务实例](#%E8%A6%81%E6%B1%82:task_access)
...
### [未声明阅读Gradle属性](#%E8%A6%81%E6%B1%82:undeclared_gradle_prop_read)
...
### [未声明读取文件](#%E6%9C%AA%E5%A3%B0%E6%98%8E%E8%AF%BB%E5%8F%96%E6%96%87%E4%BB%B6)
...
### [构建扫描支持](#%E6%9E%84%E5%BB%BA%E6%89%AB%E6%8F%8F%E6%94%AF%E6%8C%81)

启用配置缓存的构建扫描功能需要Gradle Enterprise插件版本3.4或更高版本。使用早期版本时，使用配置缓存时将自动禁用内部版本扫描发布。

### [共享配置缓存](#%E5%85%B1%E4%BA%AB%E9%85%8D%E7%BD%AE%E7%BC%93%E5%AD%98)
...
### [复合体](#%E5%A4%8D%E5%90%88%E4%BD%93)
...
### [Java对象序列化](#Java%E5%AF%B9%E8%B1%A1%E5%BA%8F%E5%88%97%E5%8C%96)
