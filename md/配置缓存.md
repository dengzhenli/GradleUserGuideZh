...
<h2 id = '#config_cache:intro'> <a href = '#config_cache:intro'>介绍</a> </h2>
...
<h3 id = '#config_cache:intro:how_does_it_work'> <a href = '#config_cache:intro:how_does_it_work'>它是如何工作的？</a> </h3>
...
<h3 id = '#config_cache:intro:performance_improvements'> <a href = '#config_cache:intro:performance_improvements'>性能提升</a> </h3>
...
<h3 id = '#config_cache:in_action'> <a href = '#config_cache:in_action'>进行配置缓存</a> </h3>

![运行帮助](img/running-help.gif)

<h2 id = '#config_cache:usage'> <a href = '#config_cache:usage'>使用配置缓存</a> </h2>
...
<h3 id = '#config_cache:usage:enable'> <a href = '#config_cache:usage:enable'>启用配置缓存</a> </h3>
...
<h3 id = '#config_cache:usage:ignore_problems'> <a href = '#config_cache:usage:ignore_problems'>忽略问题</a> </h3>
...
<h3 id = '#config_cache:usage:max_problems'> <a href = '#config_cache:usage:max_problems'>允许最大数量的问题</a> </h3>
...
<h3 id = '#config_cache:usage:invalidate'> <a href = '#config_cache:usage:invalidate'>使缓存无效</a> </h3>
...
<h2 id = '#config_cache:ide'> <a href = '#config_cache:ide'>IDE支持</a> </h2>
...
<h3 id = '#config_cache:ide:intellij'> <a href = '#config_cache:ide:intellij'>基于IntelliJ的IDE</a> </h3>
...
<h3 id = '#config_cache:ide:eclipse'> <a href = '#config_cache:ide:eclipse'>Eclipse IDE</a> </h3>
...
<h2 id = '#config_cache:plugins'> <a href = '#config_cache:plugins'>支持的插件</a> </h2>
...
<h3 id = '#config_cache:plugins:core'> <a href = '#config_cache:plugins:core'>Core Gradle插件</a> </h3>
并非所有的[Gradle核心插件都](/md/插件参考.md#plugin_reference)支持配置缓存。

![plugiconfiguration_cache_n.png](img/plugiconfiguration_cache_n.png)
  
<h3 id = '#config_cache:plugins:community'> <a href = '#config_cache:plugins:community'>社区插件</a> </h3>

请参阅问题[gradle /
gradle＃13490](https://github.com/gradle/gradle/issues/13490)了解社区插件的状态。

<h2 id = '#config_cache:troubleshooting'> <a href = '#config_cache:troubleshooting'>故障排除</a> </h2>
...
<h2 id = '#config_cache:adoption'> <a href = '#config_cache:adoption'>Adoption steps （采纳步骤)</a> </h2>
...
<h2 id = '#config_cache:testing'> <a href = '#config_cache:testing'>测试您的构建逻辑</a> </h2>
...
<h2 id = '#config_cache:requirements'> <a href = '#config_cache:requirements'>要求</a> </h2>
...
<h3 id = '#config_cache:requirements:disallowed_types'> <a href = '#config_cache:requirements:disallowed_types'>某些类型不能被任务引用</a> </h3>
...
<h3 id = '#config_cache:requirements:use_project_during_execution'> <a href = '#config_cache:requirements:use_project_during_execution'>使用`Project`对象</a> </h3>
...
<h3 id = '#config_cache:requirements:task_access'> <a href = '#config_cache:requirements:task_access'>从另一个实例访问任务实例</a> </h3>
...
<h3 id = '#config_cache:requirements:build_listeners'> <a href = '#config_cache:requirements:build_listeners'>使用构建监听器</a> </h3>
...
<h3 id = '#config_cache:requirements:undeclared_gradle_prop_read'> <a href = '#config_cache:requirements:undeclared_gradle_prop_read'>未声明阅读Gradle属性</a> </h3>
...
<h3 id = '#config_cache:requirements:undeclared_sys_prop_read'> <a href = '#config_cache:requirements:undeclared_sys_prop_read'>未经声明的读取系统属性</a> </h3>
...
<h3 id = '#config_cache:requirements:undeclared_env_var_read'> <a href = '#config_cache:requirements:undeclared_env_var_read'>未经声明的读取环境变量</a> </h3>
...
<h3 id = '#config_cache:requirements:undeclared_file_read'> <a href = '#config_cache:requirements:undeclared_file_read'>未声明读取文件</a> </h3>
...
<h2 id = '#config_cache:not_yet_implemented'> <a href = '#config_cache:not_yet_implemented'>尚未实现</a> </h2>

使用某些Gradle功能使用配置缓存的支持尚未实现。这些功能的支持将在以后的Gradle版本中添加。

<h3 id = '#config_cache:not_yet_implemented:build_scan'> <a href = '#config_cache:not_yet_implemented:build_scan'>构建扫描支持</a> </h3>

启用配置缓存的构建扫描功能需要Gradle Enterprise插件版本3.4或更高版本。使用早期版本时，使用配置缓存时将自动禁用内部版本扫描发布。

<h3 id = '#config_cache:not_yet_implemented:sharing'> <a href = '#config_cache:not_yet_implemented:sharing'>共享配置缓存</a> </h3>
...
<h3 id = '#config_cache:not_yet_implemented:normalization'> <a href = '#config_cache:not_yet_implemented:normalization'>自定义输入标准化</a> </h3>
...
<h3 id = '#config_cache:not_yet_implemented:composite_builds'> <a href = '#config_cache:not_yet_implemented:composite_builds'>复合体</a> </h3>
...
<h3 id = '#config_cache:not_yet_implemented:source_dependencies'> <a href = '#config_cache:not_yet_implemented:source_dependencies'>源依赖</a> </h3>
...
<h3 id = '#config_cache:not_yet_implemented:testkit_build_with_java_agent'> <a href = '#config_cache:not_yet_implemented:testkit_build_with_java_agent'>将Java代理与使用TestKit运行的构建一起使用</a> </h3>

使用[TestKit](/md/使用TestKit测试构建逻辑.md#test_kit)运行内部版本时，配置缓存可能会干扰应用于这些内部版本的Java代理（例如Jacoco代理）。

<h3 id = '#config_cache:not_yet_implemented:java_serialization'> <a href = '#config_cache:not_yet_implemented:java_serialization'>Java对象序列化</a> </h3>
