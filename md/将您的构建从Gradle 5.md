...
内容
  ...
  * [从5.6及更早版本升级](#从5_6及更早版本升级)
  * [从5.5或更早版本升级](#从5_5或更早版本升级)
  * [从5.4或更早版本升级](#从5_4或更早版本升级)
  * [从5.3或更早版本升级](#从5_3或更早版本升级)
  * [从5.2或更早版本升级](#从5_2或更早版本升级)
  * [从5.1或更早版本升级](#从5_1或更早版本升级)
  * [从5.0或更早版本升级](#从5_0或更早版本升级)
...
#### [API`BuildListener_buildStarted`和`Gradle_buildStarted`已被弃用](#API`BuildListener_buildStarted`和`Gradle_buildStarted`已被弃用)
...
#### [不建议调用`Project_afterEvaluate`评估项目](#不建议调用`Project_afterEvaluate`评估项目)
...
#### [`ivy_xml`Java库的出版物包含更多信息](#`ivy_xml`Java库的出版物包含更多信息)
...
#### [方法`AbstractCompile_compile()`method已删除](#方法`AbstractCompile_compile()`method已删除)
...
#### [方法`WorkerExecutor_submit()`已弃用](#方法`WorkerExecutor_submit()`已弃用)
...
#### [`publishing_publications`和的名称验证得到增强`publishing_repositories`](#`publishing_publications`和的名称验证得到增强`publishing_repositories`)
...
#### [默认PMD版本已升级到6_15_0](#默认PMD版本已升级到6_15_0)
...
#### [嵌入式Kotlin升级到1_3_41](#嵌入式Kotlin升级到1_3_41)
...
#### [JaCoCo的默认版本已升级到0_8_4](#JaCoCo的默认版本已升级到0_8_4)
...
#### [嵌入式Ant版本已升级到1_9_14](#嵌入式Ant版本已升级到1_9_14)
...
#### [通过依赖替换在Maven/Ivy互操作性中的错误修复](#通过依赖替换在Maven%2fIvy互操作性中的错误修复)
...
## [从5_1或更早版本升级](#从5_1或更早版本升级)

### [潜在的重大变化](#潜在的重大变化)

没有

## [从5_0或更早版本升级](#从5_0或更早版本升级)
