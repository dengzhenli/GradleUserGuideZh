...
<h2 id = '#sec:standard_attributes'> <a href = '#sec:standard_attributes'>Gradle定义的标准属性</a> </h2>
...
属性名称 | 描述 | 价值观 | 兼容性和消歧规则  
---|---  |---|---    
`org.gradle.status`|组件级别属性，派生|基于[状态方案](/md/使用组件元数据规则修复元数据.md#sec:custom_status_scheme)，默认情况下基于源存储库。|根据使用的方案  
  
<h3 id = '#sub:jvm_default_attributes'> <a href = '#sub:jvm_default_attributes'>JVM生态系统特定的属性</a> </h3>
...
<h2 id = '#sec:declaring_attributes'> <a href = '#sec:declaring_attributes'>声明自定义属性</a> </h2>
...
<h3 id = '#sec:abm_compatibility_rules'> <a href = '#sec:abm_compatibility_rules'>属性兼容性规则</a> </h3>
...
<h3 id = '#sec:abm_disambiguation_rules'> <a href = '#sec:abm_disambiguation_rules'>属性消歧规则</a> </h3>
