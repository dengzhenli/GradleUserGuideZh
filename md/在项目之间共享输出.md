...
<h2 id = '#sec:simple-sharing-artifacts-between-projects'> <a href = '#sec:simple-sharing-artifacts-between-projects'>项目之间工件的简单共享</a> </h2>
...
<h2 id = '#sec:variant-aware-sharing'> <a href = '#sec:variant-aware-sharing'>项目之间工件的变体感知共享</a> </h2>
