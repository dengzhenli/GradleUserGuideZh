...
[ 推特 ](https://twitter.com/gradle)
  ...
  * [Gradle API](file:///Users/dxs/temp/gradle-6.7.1/docs/userguide/dependency_constraints.html#gradle-api)
...
[ PDF格式 ](file:///Users/dxs/temp/gradle-6.7.1/docs/userguide/userguide.pdf)
  ...
  * [升级Gradle ...](file:///Users/dxs/temp/gradle-6.7.1/docs/userguide/dependency_constraints.html#upgrading-gradle)
  ...
  * [迁移至Gradle ...](file:///Users/dxs/temp/gradle-6.7.1/docs/userguide/dependency_constraints.html#migrating-to-gradle)
...
### 运行Gradle构建
  ...
  * [自定义执行](file:///Users/dxs/temp/gradle-6.7.1/docs/userguide/dependency_constraints.html#customizing-execution)
  ...
  * [优化构建时间](file:///Users/dxs/temp/gradle-6.7.1/docs/userguide/dependency_constraints.html#optimizing-build-performance)
...
### 编写Gradle构建
  ...
  * [学习基础](file:///Users/dxs/temp/gradle-6.7.1/docs/userguide/dependency_constraints.html#learning-the-basics)
  ...
  * [创作多项目构建](file:///Users/dxs/temp/gradle-6.7.1/docs/userguide/dependency_constraints.html#authoring-multi-project-builds)
  ...
  * [创作可持续建筑](file:///Users/dxs/temp/gradle-6.7.1/docs/userguide/dependency_constraints.html#authoring-sustainable-builds)
  ...
  * [先进技术](file:///Users/dxs/temp/gradle-6.7.1/docs/userguide/dependency_constraints.html#advanced-techniques)
...
### 编写JVM构建
  ...
  * [JVM插件](file:///Users/dxs/temp/gradle-6.7.1/docs/userguide/dependency_constraints.html#jvm-plugins)
...
### 使用依赖项
  ...
  * [学习基础](file:///Users/dxs/temp/gradle-6.7.1/docs/userguide/dependency_constraints.html#learning-the-basics-dependency-management)
  ...
  * [声明版本](file:///Users/dxs/temp/gradle-6.7.1/docs/userguide/dependency_constraints.html#declaring-dependency-versions)
  ...
  * [控制翻译](file:///Users/dxs/temp/gradle-6.7.1/docs/userguide/dependency_constraints.html#controlling-transitive-dependencies)
  ...
  * [图书馆的生产和消费形式](file:///Users/dxs/temp/gradle-6.7.1/docs/userguide/dependency_constraints.html#modeling-features)
  ...
  * [在多仓库环境中工作](file:///Users/dxs/temp/gradle-6.7.1/docs/userguide/dependency_constraints.html#multi-repo)
    * [Composing Builds](file:///Users/dxs/temp/gradle-6.7.1/docs/userguide/composite_builds.html)
  * [出版图书馆](file:///Users/dxs/temp/gradle-6.7.1/docs/userguide/dependency_constraints.html#publishing)
...
内容
  ...
  * [直接依赖与依赖约束](file:///Users/dxs/temp/gradle-6.7.1/docs/userguide/dependency_constraints.html#sec:direct-vs-transitive-deps)
  * [在传递依赖项上添加约束](file:///Users/dxs/temp/gradle-6.7.1/docs/userguide/dependency_constraints.html#sec:adding-constraints-transitive-deps)

##
[](file:///Users/dxs/temp/gradle-6.7.1/docs/userguide/dependency_constraints.html#sec:direct-
vs-transitive-
deps)[直接依赖与依赖约束](file:///Users/dxs/temp/gradle-6.7.1/docs/userguide/dependency_constraints.html#sec:direct-
vs-transitive-deps)
...
##
[](file:///Users/dxs/temp/gradle-6.7.1/docs/userguide/dependency_constraints.html#sec:adding-
constraints-transitive-
deps)[在传递依赖项上添加约束](file:///Users/dxs/temp/gradle-6.7.1/docs/userguide/dependency_constraints.html#sec:adding-
constraints-transitive-deps)

依赖关系约束允许您定义在构建脚本中声明的依赖关系和传递性依赖关系的版本或版本范围。表达约束的首选方法是应将约束应用于配置的所有依赖项。当Gradle尝试将对模块版本的依赖项解析为所有[依赖项声明时](file:///Users/dxs/temp/gradle-6.7.1/docs/userguide/rich_versions.html)，该模块的所有传递依赖关系和所有依赖关系约束都被考虑在内。选择符合所有条件的最高版本。如果找不到这样的版本，Gradle将失败，并显示一条错误的声明。如果发生这种情况，您可以调整依赖项或依赖项约束声明，或者根据需要对传递性依赖项进行其他调整。与依赖项声明类似，依赖项约束声明[受配置范围限制，](file:///Users/dxs/temp/gradle-6.7.1/docs/userguide/declaring_dependencies.html#sec:what-
are-dependency-
configurations)因此可以为构建的某些部分选择性地定义。如果依赖性约束影响了解析结果，则以后仍然可以应用任何类型的[依赖性解析规则](file:///Users/dxs/temp/gradle-6.7.1/docs/userguide/resolution_rules.html#sec:dependency_resolve_rules)。
...
codec`在项目中未将其定义为依赖项。否则，约束无效。依赖关系约束还可以定义[丰富的版本约束，](file:///Users/dxs/temp/gradle-6.7.1/docs/userguide/rich_versions.html)并支持[严格的版本](file:///Users/dxs/temp/gradle-6.7.1/docs/userguide/rich_versions.html#sec:strict-
version)以强制执行版本，即使它与传递依赖关系定义的版本相抵触（例如，如果需要降级）。

__ |

依赖性约束仅在使用[Gradle Module
Metadata](file:///Users/dxs/temp/gradle-6.7.1/docs/userguide/publishing_gradle_module_metadata.html#sec:understanding-
gradle-module-
md)时发布。这意味着当前仅在使用Gradle进行发布和使用时才完全支持它们（即，在使用Maven或Ivy使用模块时它们会“丢失”）。  
...
![Google 翻译](./升级传递依赖的版本_files/translate_24dp.png)
