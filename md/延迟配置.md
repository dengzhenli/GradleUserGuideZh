...
惰性属性旨在传递，并且仅在需要时才查询。通常，这将在执行阶段发生。有关Gradle构建阶段的更多信息，请参见[构建生命周期](/md/构建生命周期.md#sec:build_phases)。
...
<h2 id = 'https://docs.gradle.org/6.7.1/userguide/lazy_configuration.html#lazy_configuration_reference'> <a href = 'https://docs.gradle.org/6.7.1/userguide/lazy_configuration.html#lazy_configuration_reference'>提供程序文件API参考</a> </h2>
