...
<h2 id = '#lazy_properties'> <a href = '#lazy_properties'>惰性集合</a> </h2>
...
惰性属性旨在传递，并且仅在需要时才查询。通常，这将在执行阶段发生。有关Gradle构建阶段的更多信息，请参见[构建生命周期](/md/构建生命周期.md#sec_build_phases)。
...
<h2 id = '#creating_property_provider'> <a href = '#creating_property_provider'>创建属性或提供程序实例</a> </h2>
...
<h2 id = '#connecting_properties_together'> <a href = '#connecting_properties_together'>将属性连接在一起</a> </h2>
...
<h2 id = '#working_with_files_in_lazy_properties'> <a href = '#working_with_files_in_lazy_properties'>处理文件</a> </h2>
...
<h2 id = '#working_with_task_dependencies_in_lazy_properties'> <a href = '#working_with_task_dependencies_in_lazy_properties'>使用任务输入和输出</a> </h2>
...
<h2 id = '#working_with_collections'> <a href = '#working_with_collections'>使用收藏</a> </h2>
...
<h2 id = '#working_with_maps'> <a href = '#working_with_maps'>使用地图</a> </h2>
...
<h2 id = '#applying_conventions'> <a href = '#applying_conventions'>将约定应用于属性</a> </h2>
...
<h2 id = '#unmodifiable_property'> <a href = '#unmodifiable_property'>使财产不可修改</a> </h2>
...
<h2 id = '#lazy_configuration_faqs'> <a href = '#lazy_configuration_faqs'>指导方针</a> </h2>
...
<h2 id = '#lazy_configuration_roadmap'> <a href = '#lazy_configuration_roadmap'>未来发展</a> </h2>

展望未来，新属性将使用提供者API。Groovy Gradle
DSL添加了便捷的方法，以使提供程序的使用在构建脚本中几乎是透明的。现有任务将根据需要并以向后兼容的方式将其现有的“原始”属性替换为提供程序。新任务将使用提供程序API设计。

<h2 id = 'https_//docs_gradle_org/6_7_1/userguide/lazy_configuration_html#lazy_configuration_reference'> <a href = 'https_//docs_gradle_org/6_7_1/userguide/lazy_configuration_html#lazy_configuration_reference'>提供程序文件API参考</a> </h2>
