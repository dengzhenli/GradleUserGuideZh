...
执行此命令行将使Gradle执行以下操作：
  ...
  * 解决所有[可解决的配置](https://docs.gradle.org/6.7.1/userguide/declaring_dependencies.html#sec:resolvable-consumable-configs)，包括：
...
## [](#sec:troubleshooting-verification)[对依赖关系验证进行故障排除](#sec:troubleshooting-verification)
