...
您可以使用“[日志级别”命令行选项中](#logLevelCommandLineOptions)显示的命令行开关来选择不同的日志级别。您还可以使用来配置日志级别`gradle.properties`，请参阅[Gradle属性](/md/Gradle环境搭建.md#Gradle属性)。在[Stacktrace命令行选项中，](#Stacktrace%E5%91%BD%E4%BB%A4%E8%A1%8C%E9%80%89%E9%A1%B9)您会找到影响stacktrace日志记录的命令行开关。
