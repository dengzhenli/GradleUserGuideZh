...
如在[不同类型的配置中所述](/md/%E5%A3%B0%E6%98%8E%E4%BE%9D%E8%B5%96.md%23%E5%8F%AF%E8%A7%A3%E6%9E%90%E5%92%8C%E6%B6%88%E8%80%97%E6%80%A7%E9%85%8D%E7%BD%AE)，对于相同的依赖项可能会有不同的变体。例如，外部Maven依赖项具有针对依赖项（`java-
...
④  做转换的实际工作  
╚═════════════════════════════   
伪像转换可能需要参数，例如`String`确定一些过滤器或某些文件集合，这些参数用于支持输入伪像的转换。为了将这些参数传递给转换动作，您需要使用所需参数定义一个新类型。该类型需要实现标记接口[TransformParameters](https://docs.gradle.org/6.7.1/javadoc/org/gradle/api/artifacts/transform/TransformParameters.html)。必须使用[托管属性](/md/%E5%BC%80%E5%8F%91%E8%87%AA%E5%AE%9A%E4%B9%89Gradle%E7%B1%BB%E5%9E%8B.md%23%E6%89%98%E7%AE%A1%E5%B1%9E%E6%80%A7)来表示参数，并且参数类型必须是[托管类型](/md/%E5%BC%80%E5%8F%91%E8%87%AA%E5%AE%9A%E4%B9%89Gradle%E7%B1%BB%E5%9E%8B.md%23%E6%89%98%E7%AE%A1%E7%B1%BB%E5%9E%8B)。您可以使用接口或抽象类声明getter，然后Gradle将生成实现。所有吸气剂都需要具有正确的输入注释，请参阅“[增量构建](/md/处理任务.md#table:incremental_build_annotations)”部分中的表。
...
与[增量任务](/md/%E5%BC%80%E5%8F%91%E8%87%AA%E5%AE%9A%E4%B9%89Gradle%E4%BB%BB%E5%8A%A1%E7%B1%BB%E5%9E%8B.md%23%E5%A2%9E%E9%87%8F%E4%BB%BB%E5%8A%A1)类似，工件转换可以通过仅处理上次执行后更改的文件来避免工作。这是通过使用[InputChanges](https://docs.gradle.org/6.7.1/dsl/org.gradle.work.InputChanges.html)接口完成的。对于工件转换，只有输入工件是增量输入，因此转换只能查询那里的更改。为了在转换动作中使用[InputChanges](https://docs.gradle.org/6.7.1/dsl/org.gradle.work.InputChanges.html)，请将其注入到动作中。有关如何使用[InputChanges的](https://docs.gradle.org/6.7.1/dsl/org.gradle.work.InputChanges.html)更多信息，请参见有关[增量任务](/md/%E5%BC%80%E5%8F%91%E8%87%AA%E5%AE%9A%E4%B9%89Gradle%E4%BB%BB%E5%8A%A1%E7%B1%BB%E5%9E%8B.md%23%E5%A2%9E%E9%87%8F%E4%BB%BB%E5%8A%A1)的相应文档。
