...
<h2 id = '#sec:abm_configuration_attributes'> <a href = '#sec:abm_configuration_attributes'>配置和变量属性</a> </h2>
...
<h2 id = '#sec:variant-visual'> <a href = '#sec:variant-visual'>可视化变体信息</a> </h2>
...
<h2 id = '#sec:variant-aware-matching'> <a href = '#sec:variant-aware-matching'>变体匹配</a> </h2>
...
<h2 id = '#sec:variant-select-errors'> <a href = '#sec:variant-select-errors'>变体选择错误</a> </h2>
...
<h3 id = '#sub:variant-ambiguity'> <a href = '#sub:variant-ambiguity'>处理模棱两可的变量选择错误</a> </h3>
...
<h3 id = '#sub:variant-no-match'> <a href = '#sub:variant-no-match'>处理无匹配的变体错误</a> </h3>
...
<h2 id = '#sec:mapping-maven-ivy-to-variants'> <a href = '#sec:mapping-maven-ivy-to-variants'>从Maven /Ivy映射到变体</a> </h2>
...
<h3 id = '#sub:maven-mapping-to-variants'> <a href = '#sub:maven-mapping-to-variants'>将POM文件映射到变体</a> </h3>
...
<h3 id = '#sub:ivy-mapping-to-variants'> <a href = '#sub:ivy-mapping-to-variants'>将Ivy文件映射到变体</a> </h3>
