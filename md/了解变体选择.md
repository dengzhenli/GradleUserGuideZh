...
内容
  ...
  * [变体匹配](#变体匹配)
  * [变体选择错误](#变体选择错误)
  * [从Maven / Ivy映射到变体](#从Maven_╱Ivy映射到变体)
...
由于历史原因，Gradle区分两种组件：
  ...
  * 外部组件，在存储库上发布，在这种情况下，该模块要么通过Gradle Module Metadata发布，并且本机支持变体，要么该模块使用Ivy / Maven元数据，而[变体则从元数据派生](#从Maven_╱Ivy映射到变体)。
...
## [从Maven_╱Ivy映射到变体](#从Maven_╱Ivy映射到变体)
