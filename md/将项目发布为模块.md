...
从Gradle
6.0开始，[Gradle模块元数据](https://docs.gradle.org/6.7.1/userguide/publishing_gradle_module_metadata.html#sec:understanding-gradle-module-md)将始终与Ivy XML或Maven POM元数据文件一起发布。
...
Gradle通过以[Maven Publish插件](https://docs.gradle.org/6.7.1/userguide/publishing_maven.html#publishing_maven)和[Ivy Publish插件](https://docs.gradle.org/6.7.1/userguide/publishing_ivy.html#publishing_ivy)的形式提供一些预打包的基础结构，使发布到这些类型的存储库变得容易。这些插件使您可以配置要发布的内容并以最小的努力执行发布。
...
Gradle需要知道要发布哪些文件和信息，以便消费者可以使用您的项目。这通常是Gradle称为[出版物](https://docs.gradle.org/6.7.1/userguide/dependency_management_terminology.html#sub:terminology_publication)的[工件](https://docs.gradle.org/6.7.1/userguide/dependency_management_terminology.html#sub:terminology_artifact)和元数据的组合。出版物中包含的内容确切取决于要发布到的存储库的类型。[](https://docs.gradle.org/6.7.1/userguide/dependency_management_terminology.html#sub:terminology_publication)
...
另外，Gradle将发布上述所有内容的校验和，并在配置时发布[签名](https://docs.gradle.org/6.7.1/userguide/publishing_signing.html)。从Gradle
...
[组件](https://docs.gradle.org/6.7.1/userguide/dependency_management_terminology.html#sub:terminology_component)表示。
