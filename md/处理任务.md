...
内容
  ...
  * [任务成果](#%E4%BB%BB%E5%8A%A1%E6%88%90%E6%9E%9C)
  * [定义任务](#%E5%AE%9A%E4%B9%89%E4%BB%BB%E5%8A%A1)
  * [定位任务](#%E5%AE%9A%E4%BD%8D%E4%BB%BB%E5%8A%A1)
  * [配置任务](#%E9%85%8D%E7%BD%AE%E4%BB%BB%E5%8A%A1)
  * [将参数传递给任务构造函数](#%E5%B0%86%E5%8F%82%E6%95%B0%E4%BC%A0%E9%80%92%E7%BB%99%E4%BB%BB%E5%8A%A1%E6%9E%84%E9%80%A0%E5%87%BD%E6%95%B0)
  * [向任务添加依赖项](#%E5%90%91%E4%BB%BB%E5%8A%A1%E6%B7%BB%E5%8A%A0%E4%BE%9D%E8%B5%96%E9%A1%B9)
  * [订购任务](#%E8%AE%A2%E8%B4%AD%E4%BB%BB%E5%8A%A1)
  * [为任务添加描述](#%E4%B8%BA%E4%BB%BB%E5%8A%A1%E6%B7%BB%E5%8A%A0%E6%8F%8F%E8%BF%B0)
  * [跳过任务](#%E8%B7%B3%E8%BF%87%E4%BB%BB%E5%8A%A1)
  * [最新检查（又称增量构建）](#%E6%9C%80%E6%96%B0%E6%A3%80%E6%9F%A5%EF%BC%88%E5%8F%88%E7%A7%B0%E5%A2%9E%E9%87%8F%E6%9E%84%E5%BB%BA%EF%BC%89)
  * [任务规则](#%E4%BB%BB%E5%8A%A1%E8%A7%84%E5%88%99)
  * [终结器任务](#%E7%BB%88%E7%BB%93%E5%99%A8%E4%BB%BB%E5%8A%A1)
  * [生命周期任务](#%E7%94%9F%E5%91%BD%E5%91%A8%E6%9C%9F%E4%BB%BB%E5%8A%A1)
...
API](/md/Gradle%E5%92%8C%E7%AC%AC%E4%B8%89%E6%96%B9%E5%B7%A5%E5%85%B7.md%23%E4%BD%BF%E7%94%A8Tooling+API%E5%B5%8C%E5%85%A5Gradle)将任务标记为不同的结果。这些标签基于任务是否具有要执行的动作，是否应执行那些动作，是否确实执行了这些动作以及这些动作是否进行了任何更改。
...
任务执行了其动作。
  ...
  * Task没有动作，并且有一些依赖关系，并且任何依赖关系都将执行。另请参见[生命周期任务](#%E7%94%9F%E5%91%BD%E5%91%A8%E6%9C%9F%E4%BB%BB%E5%8A%A1)。
...
任务的输出未更改。
  ...
  * 任务具有输出和输入，并且它们没有改变。请参阅[增量构建](#%E6%9C%80%E6%96%B0%E6%A3%80%E6%9F%A5%EF%BC%88%E5%8F%88%E7%A7%B0%E5%A2%9E%E9%87%8F%E6%9E%84%E5%BB%BA%EF%BC%89)。

  * 任务有动作，但是任务告诉Gradle它没有更改其输出。

  * 任务没有任何动作，并且有一些依赖关系，但是所有依赖关系都是最新的，已跳过或来自缓存。另请参见[生命周期任务](#%E7%94%9F%E5%91%BD%E5%91%A8%E6%9C%9F%E4%BB%BB%E5%8A%A1)。
...
任务未执行其动作。
  ...
  * 任务已从命令行中明确排除。请参阅[从执行中排除任务](/md/%E5%91%BD%E4%BB%A4%E8%A1%8C%E7%95%8C%E9%9D%A2.md%23%E4%BB%8E%E6%89%A7%E8%A1%8C%E4%B8%AD%E6%8E%92%E9%99%A4%E4%BB%BB%E5%8A%A1)。

  * 任务有一个`onlyIf`谓词返回false。请参阅[使用谓词](#%E4%BD%BF%E7%94%A8%E8%B0%93%E8%AF%8D)。
...
您可以通过多种方式定义任务的依赖关系。在“[任务依赖项”中](/md/%E6%9E%84%E5%BB%BA%E8%84%9A%E6%9C%AC%E5%9F%BA%E7%A1%80.md%23%E4%BB%BB%E5%8A%A1%E4%BE%9D%E8%B5%96%E6%80%A7)，介绍了使用任务名称定义依赖项。任务名称可以引用与该任务在同一项目中的任务，也可以引用其他项目中的任务。要引用另一个项目中的任务，请在任务名称前添加其所属项目的路径。以下是添加从`project-a:taskX`到的依赖的示例`project-b:taskY`：
...
### [使用谓词](#%E4%BD%BF%E7%94%A8%E8%B0%93%E8%AF%8D)
...
### [使用StopExecutionException](#%E4%BD%BF%E7%94%A8StopExecutionException)
...
### [启用和禁用任务](#%E5%90%AF%E7%94%A8%E5%92%8C%E7%A6%81%E7%94%A8%E4%BB%BB%E5%8A%A1)
...
### [任务超时](#%E4%BB%BB%E5%8A%A1%E8%B6%85%E6%97%B6)
...
DATE`运行构建时，几乎每次在任务名称旁边出现文本时，它就处于活动状态。任务结果在[任务结果中](#%E4%BB%BB%E5%8A%A1%E6%88%90%E6%9E%9C)进行了描述。

增量构建如何工作？在自己的任务中需要使用什么呢？让我们来看看。

### [任务输入和输出](#%E4%BB%BB%E5%8A%A1%E8%BE%93%E5%85%A5%E5%92%8C%E8%BE%93%E5%87%BA)
...
这些带注释的属性意味着，自从Gradle上次执行任务以来，如果源文件，模板引擎，模型数据或生成的文件均未更改，则Gradle将跳过任务。这通常会节省大量时间。您可以[稍后](#%E5%AE%83%E6%98%AF%E5%A6%82%E4%BD%95%E5%B7%A5%E4%BD%9C%E7%9A%84%EF%BC%9F)了解Gradle如何检测[更改](#%E5%AE%83%E6%98%AF%E5%A6%82%E4%BD%95%E5%B7%A5%E4%BD%9C%E7%9A%84%EF%BC%9F)。

这个示例特别有趣，因为它可以处理源文件的集合。如果仅更改一个源文件，会发生什么？该任务会再次处理所有源文件还是仅处理已修改的源文件？这取决于任务的实现。如果是后者，那么任务本身就是增量的，但这与我们在此讨论的功能不同。Gradle通过其[增量任务输入](/md/%E5%BC%80%E5%8F%91%E8%87%AA%E5%AE%9A%E4%B9%89Gradle%E4%BB%BB%E5%8A%A1%E7%B1%BB%E5%9E%8B.md%23%E5%A2%9E%E9%87%8F%E4%BB%BB%E5%8A%A1)功能确实可以帮助任务实施者。
...
@[OutputFiles](https://docs.gradle.org/6.7.1/javadoc/org/gradle/api/tasks/OutputFiles.html)|`Map<String, File>`**或`Iterable<File>`*|输出文件的可迭代或映射。使用文件树将关闭该任务的[缓存](/md/%E6%9E%84%E5%BB%BA%E7%BC%93%E5%AD%98.md%23%E4%BB%BB%E5%8A%A1%E8%BE%93%E5%87%BA%E7%BC%93%E5%AD%98)。  
@[OutputDirectories](https://docs.gradle.org/6.7.1/javadoc/org/gradle/api/tasks/OutputDirectories.html)|`Map<String, File>`**或`Iterable<File>`*|可迭代的输出目录。使用文件树将关闭该任务的[缓存](/md/%E6%9E%84%E5%BB%BA%E7%BC%93%E5%AD%98.md%23%E4%BB%BB%E5%8A%A1%E8%BE%93%E5%87%BA%E7%BC%93%E5%AD%98)。  
...
@[LocalState](https://docs.gradle.org/6.7.1/javadoc/org/gradle/api/tasks/LocalState.html)|`File`或`Iterable<File>`*|指定一个或多个表示[任务本地状态的](/md/%E5%BC%80%E5%8F%91%E8%87%AA%E5%AE%9A%E4%B9%89Gradle%E4%BB%BB%E5%8A%A1%E7%B1%BB%E5%9E%8B.md%23%E4%B8%BA%E7%BC%93%E5%AD%98%E7%9A%84%E4%BB%BB%E5%8A%A1%E5%AD%98%E5%82%A8%E5%A2%9E%E9%87%8F%E7%8A%B6%E6%80%81)文件。从缓存中加载任务时，将删除这些文件。  
...
@[Incremental](https://docs.gradle.org/6.7.1/javadoc/org/gradle/work/Incremental.html)|`Provider<FileSystemLocation>` 要么 `FileCollection`|与`@InputFiles`或`@InputDirectory`一起指示Gradle跟踪对带注释的文件属性的更改，因此可以通过来查询更改。[增量任务](/md/%E5%BC%80%E5%8F%91%E8%87%AA%E5%AE%9A%E4%B9%89Gradle%E4%BB%BB%E5%8A%A1%E7%B1%BB%E5%9E%8B.md%23%E5%A2%9E%E9%87%8F%E4%BB%BB%E5%8A%A1)所需。`@[InputChanges.getFileChanges()](https://docs.gradle.org/6.7.1/dsl/org.gradle.work.InputChanges.html)`[](/md/%E5%BC%80%E5%8F%91%E8%87%AA%E5%AE%9A%E4%B9%89Gradle%E4%BB%BB%E5%8A%A1%E7%B1%BB%E5%9E%8B.md%23%E5%A2%9E%E9%87%8F%E4%BB%BB%E5%8A%A1)  
@[Optional](https://docs.gradle.org/6.7.1/javadoc/org/gradle/api/tasks/Optional.html)|随便哪种|与[可选](https://docs.gradle.org/6.7.1/javadoc/org/gradle/api/tasks/Optional.html)API文档中列出的任何属性类型注释一起使用。此批注禁用对相应属性的验证检查。有关更多详细信息，请参见[验证部分](#%E8%BE%93%E5%85%A5%E5%92%8C%E8%BE%93%E5%87%BA%E9%AA%8C%E8%AF%81)。  
...
##### [使用类路径注释](#%E4%BD%BF%E7%94%A8%E7%B1%BB%E8%B7%AF%E5%BE%84%E6%B3%A8%E9%87%8A)
...
运行时类路径用标记，并且它们通过[类路径规范化](#%E9%85%8D%E7%BD%AE%E8%BE%93%E5%85%A5%E6%A0%87%E5%87%86%E5%8C%96)提供进一步的自定义。`@[Classpath](https://docs.gradle.org/6.7.1/javadoc/org/gradle/api/tasks/Classpath.html)`[](#%E9%85%8D%E7%BD%AE%E8%BE%93%E5%85%A5%E6%A0%87%E5%87%86%E5%8C%96)
...
##### [嵌套输入](#%E5%B5%8C%E5%A5%97%E8%BE%93%E5%85%A5)
...
##### [运行时验证](#%E8%BF%90%E8%A1%8C%E6%97%B6%E9%AA%8C%E8%AF%81)
...
#### [运行时API](#%E8%BF%90%E8%A1%8C%E6%97%B6API)
...
##### [将其用于临时任务](#%E5%B0%86%E5%85%B6%E7%94%A8%E4%BA%8E%E4%B8%B4%E6%97%B6%E4%BB%BB%E5%8A%A1)
...
##### [细粒度配置](#%E7%BB%86%E7%B2%92%E5%BA%A6%E9%85%8D%E7%BD%AE)
...
##### [将其用于自定义任务类型](#%E5%B0%86%E5%85%B6%E7%94%A8%E4%BA%8E%E8%87%AA%E5%AE%9A%E4%B9%89%E4%BB%BB%E5%8A%A1%E7%B1%BB%E5%9E%8B)
...
#### [重要的有益副作用](#%E9%87%8D%E8%A6%81%E7%9A%84%E6%9C%89%E7%9B%8A%E5%89%AF%E4%BD%9C%E7%94%A8)
...
##### [推断的任务依赖性](#%E6%8E%A8%E6%96%AD%E7%9A%84%E4%BB%BB%E5%8A%A1%E4%BE%9D%E8%B5%96%E6%80%A7)
...
##### [输入和输出验证](#%E8%BE%93%E5%85%A5%E5%92%8C%E8%BE%93%E5%87%BA%E9%AA%8C%E8%AF%81)
...
##### [持续建造](#%E6%8C%81%E7%BB%AD%E5%BB%BA%E9%80%A0)
...
您可以在[Continuous
build中](/md/%E5%91%BD%E4%BB%A4%E8%A1%8C%E7%95%8C%E9%9D%A2.md%23%E6%8C%81%E7%BB%AD%E6%9E%84%E5%BB%BA)找到有关此功能的更多信息。

##### [任务并行](#%E4%BB%BB%E5%8A%A1%E5%B9%B6%E8%A1%8C)
...
### [它是如何工作的？](#%E5%AE%83%E6%98%AF%E5%A6%82%E4%BD%95%E5%B7%A5%E4%BD%9C%E7%9A%84%EF%BC%9F)
...
任务的输入还用于计算[构建缓存](/md/构建缓存.md#build_cache)键，该键在启用后将加载任务输出。有关更多详细信息，请参见[任务输出缓存](/md/%E6%9E%84%E5%BB%BA%E7%BC%93%E5%AD%98.md%23%E4%BB%BB%E5%8A%A1%E8%BE%93%E5%87%BA%E7%BC%93%E5%AD%98)。
...
当无法精确跟踪任务，任务动作或嵌套输入的实现时，Gradle将禁用该任务的任何缓存。这意味着该任务永远不会是最新的，也不会从[构建缓存中](/md/%E6%9E%84%E5%BB%BA%E7%BC%93%E5%AD%98.md%23%E4%BB%BB%E5%8A%A1%E8%BE%93%E5%87%BA%E7%BC%93%E5%AD%98)加载。  
  
╚═════════════════════════════  
  
### [先进技术](#%E5%85%88%E8%BF%9B%E6%8A%80%E6%9C%AF)

到目前为止，您在本节中看到的所有内容都将涵盖您将遇到的大多数用例，但是有些情况需要特殊对待。接下来，我们将介绍其中一些解决方案。

#### [添加自己的缓存的输入/输出方法](#%E6%B7%BB%E5%8A%A0%E8%87%AA%E5%B7%B1%E7%9A%84%E7%BC%93%E5%AD%98%E7%9A%84%E8%BE%93%E5%85%A5%2F%E8%BE%93%E5%87%BA%E6%96%B9%E6%B3%95)
...
#### [链接`@OutputDirectory`到`@InputFiles`](#%E9%93%BE%E6%8E%A5%60%40OutputDirectory%60%E5%88%B0%60%40InputFiles%60)
...
#### [提供自定义的最新逻辑](#%E6%8F%90%E4%BE%9B%E8%87%AA%E5%AE%9A%E4%B9%89%E7%9A%84%E6%9C%80%E6%96%B0%E9%80%BB%E8%BE%91)
...
#### [配置输入标准化](#%E9%85%8D%E7%BD%AE%E8%BE%93%E5%85%A5%E6%A0%87%E5%87%86%E5%8C%96)
...
如果要对jar文件中的所有项目执行此文件添加操作，并且要为所有使用者过滤此文件，则应考虑在[约定插件中](/md/%E5%9C%A8%E5%AD%90%E9%A1%B9%E7%9B%AE%E4%B9%8B%E9%97%B4%E5%85%B1%E4%BA%AB%E6%9E%84%E5%BB%BA%E9%80%BB%E8%BE%91.md%23%E7%BA%A6%E5%AE%9A%E6%8F%92%E4%BB%B6)配置此类规范化以便在子项目之间共享。
...
##### [Java`META-INF`规范化](#Java%60META-INF%60%E8%A7%84%E8%8C%83%E5%8C%96)
...
### [旧任务输出](#%E6%97%A7%E4%BB%BB%E5%8A%A1%E8%BE%93%E5%87%BA)
...
除非生命周期任务具有操作，否则其[结果](#%E4%BB%BB%E5%8A%A1%E6%88%90%E6%9E%9C)取决于其任务依赖性。如果执行了这些依赖项中的任何一个，则将考虑生命周期任务`EXECUTED`。如果所有任务相关性都是最新的，已跳过或已从缓存中删除，则将考虑生命周期任务`UP-
TO-DATE`。
