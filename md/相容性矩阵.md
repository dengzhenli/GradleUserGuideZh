...
Other versions not listed here may or may not work.  
version 6.7.1
...
A Java version between 8 and 15 is required to execute Gradle. Java 16 and
later versions are not yet supported.

Java 6 and 7 can still be used for [compilation and forked test
execution](building_java_projects.html#sec:java_cross_compilation).
...
Gradle is tested with Android Gradle Plugin 3.4, 3.5, 3.6 and 4.0. Alpha and
beta versions may or may not work.
