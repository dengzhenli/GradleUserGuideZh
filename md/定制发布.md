...
<h2 id = '#sec:adding-variants-to-existing-components'> <a href = '#sec:adding-variants-to-existing-components'>修改现有变体并将其添加到现有组件中以进行发布</a> </h2>
...
<h2 id = '#sec:publishing-custom-components'> <a href = '#sec:publishing-custom-components'>创建和发布自定义组件</a> </h2>
...
<h2 id = '#sec:publishing_custom_artifacts_to_maven'> <a href = '#sec:publishing_custom_artifacts_to_maven'>将自定义工件添加到发布中</a> </h2>
...
<h2 id = '#sec:publishing_maven:conditional_publishing'> <a href = '#sec:publishing_maven:conditional_publishing'>将出版物限制为特定的存储库</a> </h2>
...
<h2 id = '#sec:configuring_publishing_tasks'> <a href = '#sec:configuring_publishing_tasks'>配置发布任务</a> </h2>
