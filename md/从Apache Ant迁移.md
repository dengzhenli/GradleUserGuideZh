...
另一种方法是[将Ant构建](/md/从Gradle使用Ant.md#导入Ant构建)导入到Gradle构建脚本中，并逐步替换Ant构建功能。这样可以使您在每个阶段都有一个有效的Gradle构建，但是要使Gradle任务与Ant任务一起正常工作还需要一些工作。您可以在[使用导入的版本中](#%E4%BD%BF%E7%94%A8%E5%AF%BC%E5%85%A5%E7%9A%84%E7%89%88%E6%9C%AC)了解有关此方法的更多信息。
