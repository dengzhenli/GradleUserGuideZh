...
### [1\. Gradle是通用的构建工具](#1\.%20Gradle是通用的构建工具)
...
### [3\. Gradle有几个固定的构建阶段](#3\.%20Gradle有几个固定的构建阶段)
...
### [4\. Gradle的扩展方式不止一种](#4\.%20Gradle的扩展方式不止一种)
