...
<h2 id = '#sec:copying_single_file_example'> <a href = '#sec:copying_single_file_example'>复制单个文件</a> </h2>
...
<h2 id = '#sec:copying_multiple_files_example'> <a href = '#sec:copying_multiple_files_example'>复制多个文件</a> </h2>
...
<h2 id = '#sec:copying_directories_example'> <a href = '#sec:copying_directories_example'>复制目录层次结构</a> </h2>
...
<h2 id = '#sec:creating_archives_example'> <a href = '#sec:creating_archives_example'>创建档案（zip，tar等）</a> </h2>
...
<h2 id = '#sec:unpacking_archives_example'> <a href = '#sec:unpacking_archives_example'>解压缩档案</a> </h2>

档案实际上是独立的文件系统，因此解压缩它们是将文件从该文件系统复制到本地文件系统，甚至复制到另一个档案的情况。\
Gradle通过提供一些包装器功能来实现此目的，这些包装器功能使档案可以作为文件（[文件树](#sec:file_trees)）的分层集合使用。
...
<h2 id = '#sec:creating_uber_jar_example'> <a href = '#sec:creating_uber_jar_example'>创建“超级”或“胖” JAR</a> </h2>
...
<h2 id = '#sec:creating_directories_example'> <a href = '#sec:creating_directories_example'>创建目录</a> </h2>
...
<h2 id = '#sec:moving_files_example'> <a href = '#sec:moving_files_example'>移动文件和目录</a> </h2>
...
<h2 id = '#sec:renaming_files_example'> <a href = '#sec:renaming_files_example'>重命名复制中的文件</a> </h2>
...
<h2 id = '#sec:deleting_files_example'> <a href = '#sec:deleting_files_example'>删除文件和目录</a> </h2>
...
<h2 id = '#sec:locating_files'> <a href = '#sec:locating_files'>深度文件路径</a> </h2>
...
<h3 id = '#sec:hard_coded_file_paths'> <a href = '#sec:hard_coded_file_paths'>在硬编码的文件路径上</a> </h3>
...
<h3 id = '#sec:single_file_paths'> <a href = '#sec:single_file_paths'>单个文件和目录</a> </h3>
...
<h3 id = '#sec:file_collections'> <a href = '#sec:file_collections'>文件收集</a> </h3>
...
与[上一节中](#sec:single_file_paths)介绍的[Project.file（java.lang.Object）](https://docs.gradle.org/6.7.1/dsl/org.gradle.api.Project.html#org.gradle.api.Project:file\(java.lang.Object\))方法一样，所有相对路径都相对于当前项目目录进行求值。以下示例演示了您可以使用的各种参数类型-
字符串，实例，列表和a
：[](#sec:single_file_paths)`File``[Path](https://docs.oracle.com/javase/8/docs/api/java/nio/file/Path.html)`
...
<h3 id = '#sec:file_trees'> <a href = '#sec:file_trees'>文件树</a> </h3>
...
<h3 id = '#sec:archive_contents'> <a href = '#sec:archive_contents'>将存档用作文件树</a> </h3>
...
<h3 id = '#sec:specifying_multiple_files'> <a href = '#sec:specifying_multiple_files'>了解对文件集合的隐式转换</a> </h3>
...
docs中提到的[files（）](#sec:file_collections)方法支持的任何类型来设置此属性的值。这意味着你可以，例如，属性设置为`File`，`String`，收藏，`FileCollection`甚至关闭或`Provider`。
...
到值的集合，而不是替换它们。同样，此方法接受[files（）](#sec:file_collections)方法支持的任何类型，如下所示：
...
<h2 id = '#sec:copying_files'> <a href = '#sec:copying_files'>深度复制文件</a> </h2>
...
`from()`配置。如果要将过滤应用于复制文件的子集，则需要使用[子规范](#sub:using_child_copy_specifications)。

<h3 id = '#sec:renaming_files'> <a href = '#sec:renaming_files'>重命名文件</a> </h3>
...
<h3 id = '#sec:filtering_files'> <a href = '#sec:filtering_files'>过滤文件内容（令牌替换，模板等）</a> </h3>
...
<h3 id = '#sec:using_the_copyspec_class'> <a href = '#sec:using_the_copyspec_class'>使用`CopySpec`课程</a> </h3>
...
<h4 id = '#sub:sharing_copy_specs'> <a href = '#sub:sharing_copy_specs'>共享复印规格</a> </h4>
...
<h4 id = '#sub:using_child_copy_specifications'> <a href = '#sub:using_child_copy_specifications'>使用子规范</a> </h4>
...
<h3 id = '#sec:project_copy_method'> <a href = '#sec:project_copy_method'>在自己的任务中复制文件</a> </h3>
...
<h3 id = '#sec:sync_task'> <a href = '#sec:sync_task'>使用`Sync`任务镜像目录和文件集合</a> </h3>
...
<h2 id = '#sec:archives'> <a href = '#sec:archives'>深入创建档案</a> </h2>
...
[子规范](#sub:using_child_copy_specifications)来实现。
...
<h3 id = '#sec:archive_naming'> <a href = '#sec:archive_naming'>档案命名</a> </h3>
...
<h3 id = '#sec:sharing_content_between_multiple_archives'> <a href = '#sec:sharing_content_between_multiple_archives'>在多个档案之间共享内容</a> </h3>

[如前所述](#sub:sharing_copy_specs)，您可以使用[Project.copySpec（org.gradle.api.Action）](https://docs.gradle.org/6.7.1/dsl/org.gradle.api.Project.html#org.gradle.api.Project:copySpec\(org.gradle.api.Action\))方法在存档之间共享内容。

<h3 id = '#sec:reproducible_archives'> <a href = '#sec:reproducible_archives'>可复制的构建</a> </h3>
