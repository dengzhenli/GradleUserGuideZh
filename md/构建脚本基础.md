...
<h2 id = '#sec:projects_and_tasks'> <a href = '#sec:projects_and_tasks'>projects（项目）与tasks（任务）</a> </h2>
...
<h2 id = '#sec:hello_world'> <a href = '#sec:hello_world'>Hello World</a> </h2>
...
<h2 id = '#sec:build_scripts_are_code'> <a href = '#sec:build_scripts_are_code'>构建脚本是代码</a> </h2>
...
<h2 id = '#sec:task_dependencies'> <a href = '#sec:task_dependencies'>任务依赖性</a> </h2>
...
<h2 id = '#sec:dynamic_tasks'> <a href = '#sec:dynamic_tasks'>动态任务</a> </h2>
...
<h2 id = '#sec:manipulating_existing_tasks'> <a href = '#sec:manipulating_existing_tasks'>处理现有任务</a> </h2>
...
<h2 id = '#sec:shortcut_notations'> <a href = '#sec:shortcut_notations'>Groovy DSL快捷方式符号</a> </h2>
...
<h2 id = '#sec:extra_task_properties'> <a href = '#sec:extra_task_properties'>额外任务属性</a> </h2>
...
<h2 id = '#sec:using_ant_tasks_tutorial'> <a href = '#sec:using_ant_tasks_tutorial'>使用Ant任务</a> </h2>
...
<h2 id = '#sec:using_methods'> <a href = '#sec:using_methods'>使用方法</a> </h2>
...
<h2 id = '#sec:default_tasks'> <a href = '#sec:default_tasks'>默认任务</a> </h2>
...
<h2 id = '#sec:build_script_external_dependencies'> <a href = '#sec:build_script_external_dependencies'>构建脚本的外部依赖关系</a> </h2>
